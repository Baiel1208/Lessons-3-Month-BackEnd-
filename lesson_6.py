...
def main():
    ...
    schedule.every().day.at('22:28').do(two_send_message)
    # schedule.every().saturday.at('20:24:10').do(send_message)
    schedule.every(10).seconds.do(get_price_btc)
    while True:
